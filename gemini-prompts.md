# 🎨 Gemini 社区热门 Prompt 日报

*生成时间: 2026-02-23 04:01 UTC*  
*来源: Reddit r/GoogleGemini + Imagen 3 社区*
...
- **社区热门:** 0 个 prompt
- **精选模板:** 6 个分类
- **适用模型:** Gemini 2.0 Flash/Pro, Imagen 3

---

## 🔥 社区热门 Prompt

*暂时无法获取 Reddit 数据，以下为精选模板...*
...
## 💎 Gemini/Imagen 3 使用技巧

### 核心优势
- **写实能力极强** — 人物、产品、食物照片几乎无法区分真假
- **文字渲染** — 可以在图中生成清晰可读的文字
- **长提示词友好** — 支持详细、复杂的描述
...
### 负面提示词（通常不需要，但可用）
```
blurry, low quality, distorted, deformed, watermark, text error
```
...
- [r/GoogleGemini](https://reddit.com/r/GoogleGemini) — 官方社区
- [Google AI Studio](https://aistudio.google.com) — 官方 playground
- [Imagen 3 文档](https://ai.google.dev/gemini-api/docs/imagen) — 官方指南
- [Gemini API](https://ai.google.dev/gemini-api/docs/image-generation) — 开发者文档
